...
![](图片/图片/QQ20251112-184751.png)
非树形结构：
![](图片/图片/QQ20251112-184936.png)
- 子树是不相交的(如果存在相交就是图)
...
```
![](图片/图片/QQ20251112-190218.png)![](图片/控制流程图片/QQ20251112-190229.png)
![](图片/图片/bit-2025-11-12-19-04-31.png)
## 4.树形结构实际运用场景
...
![](图片/图片/QQ20251112-194713.png)
### (2)完美二叉树
**完美二叉树由满二叉树而引出来**，是一个效率很高的数据结构。深度为`K`的完全二叉树有`n`个节点。
![](图片/图片/QQ20251112-194722.png)
要注意：**满二叉树是一种特殊的完全二叉树**
...
![](图片/图片/QQ20251113-095411.png)![](图片/图片/QQ20251113-095434.png)

### (2)链式结构
二叉树也可以用链表。通常由**数据域和左右指针域**，左右指针域表示**左孩子和右孩子所在的链节点的存储地址**。链式结构又分为二叉链和三叉链，大部分都是二叉链。
![](图片/图片/QQ20251113-100229.png)
![](图片/图片/QQ20251113-100238.png)
## 4.二叉树的性质
...
2. 不同的特性
	- 大堆时根最大
	- 小堆时根最小
![](图片/图片/QQ20251113-101136.png)
![](图片/图片/QQ20251113-101147.png)
>堆具有以下性质
...
![](图片/图片/QQ20251116-134659.png)
![](图片/控制流程图片/QQ20251116-134825.png)
由此可得：
...
![](图片/图片/QQ20251116-135137.png)
向下调整算法有一个前提：左右子树必须是一个堆，才能调整
- 将堆顶元素与堆中最后一个元素进行交换
- 删除堆中最后一个元素
- 将堆顶元素向下调整到满足堆特性为止
![](图片/图片/QQ20251116-135201.png)
```C
//删除头元素(先首位交换，再尾删，后向下排序)
void HPPop(HP* php);
...
![](图片/图片/QQ20251114-212309.png)

函数递归栈帧图：
![](图片/图片/QQ20251114-212353.png)
## 5.链式二叉树节点个数
**需用递归遍历二叉树**
```C
//查找二叉树节点
