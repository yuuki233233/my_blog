...
![](图片/左右双旋.png)
 ...
 >**对于左右双旋：** 旋转结束，原父节点**左右两子节点平衡因子不可能全为0**，左子节点平衡因子可能为：1、0、-1，右子节点平衡因子可能为：0、1、-1（不会同时出现都为0），这时由高度不同会出现3个场景，由下图可知：
 >![](图片/左右双旋结果图01.png)
 >![](图片/左右双旋结果图02.png)
 ...
 >**场景3**：`h==0`时，a/b/c都是空树，b自己就是一个新增节点，不断更新`5->10`平衡因子，引发旋转，其中8的平衡因子为0，旋转后8和10和5平衡因子jun
### 2.3.6 模拟实现左右双旋
### 2.3.7 右左双旋
### 2.3.8 模拟实现右左双旋
## 2.4 AVL树的查找
